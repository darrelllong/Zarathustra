...
- **alibaba_v206** — **LAUNCHED** (2026-04-22). **IDEA #44 decoded-feat-matched bc, seed=7 (cross-seed validation of v195).** Fresh pretrain from scratch (no hot-start). Seed=7. Config: identical to v195 (cond-dim=10, var-cond, diversity=2.0, w-stop=5.0, bc-weight=0.1, bc-k=4, bc-real-reconstruct, files-per-epoch=12, lr-g=8e-5, lr-d=4e-5, reuse-bce-weight=2.0). Acceptance bar: frozen ★ ≤ 0.042 (match v195 ATB) AND bc_diag raw > shuf by ≥ 0.05 at ep85+. Log `/home/darrell/train_alibaba_v206.log`. GradScaler skip-backward fix (2026-04-22) deployed.
