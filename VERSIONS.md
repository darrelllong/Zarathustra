...
|---------|--------------------|---------|----------------------|-------|
| Alibaba | **0.03457**       | **v164** final.pt (v162 recipe EXACTLY seed=7; IDEAS #19/#20/#21 BS+OC overlap-mode; fresh pretrain) | n/a | Reproducible alibaba ATB. 2026-04-19 AM: v167 was previously promoted to ★=0.02915 but the **three-seed basin {seed=7: 0.02915, seed=11: 0.08054, seed=13: 0.04186}** (v172/v173 post-mortems) showed the result was seed-lottery, not a reproducible mechanism. v167 retracted from ATB; v164 re-instated as the stable baseline to beat. Deterministic `frozen_sweep` (seeds 42/42): final.pt MMD²=0.00677, β-recall=0.8610 → ★=0.03457. All NEW mechanism candidates must beat **0.03457** under seed=7 AND show reproducibility under at least one other seed before being promoted. |
