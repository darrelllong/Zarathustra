...
- **alibaba_v194** — **RUNNING** (PID 3288889, launched 2026-04-21). **IDEA #36 decoded-mode bc + `--w-stop-threshold 5.0`**, seed=5. Decoded-feat mode (NOT latent-H). Pretrain: v193 `pretrain_complete.pt` (seed=5). Same seed as ATB holder v165 (★=0.051). Hypothesis: decoded-mode bc (v191 approach) with seed=5 basin + higher w-stop-threshold allows late-epoch frozen recovery past ep83 kill point. EMA trajectory: ep5 recall=0.572 ★=0.100; ep10 recall=0.740 ★=0.069; ep15 recall=0.708 ★=0.070; ep20 recall=0.730 ★=0.065; ep25 recall=0.691 ★=0.080 (mild collapse); ep30 recall=0.635 ★=0.093; **ep35 recall=0.750 ★=0.058 (recovery)**; **ep40 recall=0.754 ★=0.057** (W=1.311). **Frozen sweeps**: ep30 ★=0.124 → ep45 ★=0.110 → ep55 ★=0.106 → ep65 ★=0.098 → ep75 ★=0.069 → **ep80 ★=0.05869** (β-rec=0.7515, frozen-best as of sweep #6). β-recall trajectory: 0.449→0.499→0.501→0.543→0.688→**0.752**. Training selector correct: best.pt=ep80 (0% mis-rank). EMA ep80: recall=0.863, ★=0.031. Gap to ATB: ★=0.059 vs v176 ★=0.051 = **15% worse** (was 35% at ep75). **New bc ATB: beats v191 ★=0.067 by 13%**. Training at ep82: W=2.73 (rising 2.1–2.9 range ep76–82), G=−2.09. DO NOT KILL — w-stop=5.0, W still 2.7. Watching ep85 (if β-recall reaches 0.78+ and MMD²≤0.008, ★≤0.050 = new overall ATB). Log `/home/darrell/train_alibaba_v194.log`.
