...
- **alibaba_v194** — **RUNNING** (PID 3288889, launched 2026-04-21). **IDEA #36 decoded-mode bc + `--w-stop-threshold 5.0`**, seed=5. Decoded-feat mode (NOT latent-H). Pretrain: v193 `pretrain_complete.pt` (seed=5). Same seed as ATB holder v165 (★=0.051). Hypothesis: decoded-mode bc (v191 approach) with seed=5 basin + higher w-stop-threshold allows late-epoch frozen recovery past ep83 kill point. EMA trajectory: ep5 recall=0.572 ★=0.100; ep10 recall=0.740 ★=0.069; ep15 recall=0.708 ★=0.070; ep20 recall=0.730 ★=0.065; ep25 recall=0.691 ★=0.080 (mild collapse); ep30 recall=0.635 ★=0.093; **ep35 recall=0.750 ★=0.058 (recovery)**; **ep40 recall=0.754 ★=0.057** (W=1.311). **Frozen sweep #1 (seeds 42/42, ep5–ep40, 9 ckpts)**: frozen-best epoch_0030 ★=0.12356 (β-rec=0.449). 26th mis-rank: EMA ★=0.057 → frozen ★=0.126. **Frozen sweep #2 (seeds 42/42, ep5–ep50, 11 ckpts)**: frozen-best **epoch_0045.pt ★=0.10978** (MMD²=0.00958, β-rec=0.499). Training selector correct: best.pt = ep45 (0% mis-rank). Trend: ep30 ★=0.124 → ep45 ★=0.110 — improving. EMA ep45 ★=0.052 → frozen ★=0.110 (2.1× inflation). β-recall 0.499 building toward phase transition. v194 ep45 frozen ★=0.110 vs v191 ep45 frozen ~0.138 — v194 is 21% better frozen at same epoch. Training ep52: recall=0.778 (EMA), W=1.17, stable. Phase transition window: ep55–80. Log `/home/darrell/train_alibaba_v194.log`.
