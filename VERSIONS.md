...
- **alibaba_v194** — **RUNNING** (PID 3288889, launched 2026-04-21). **IDEA #36 decoded-mode bc + `--w-stop-threshold 5.0`**, seed=5. Decoded-feat mode (NOT latent-H). Pretrain: v193 `pretrain_complete.pt` (seed=5). Same seed as ATB holder v165 (★=0.051). Hypothesis: decoded-mode bc (v191 approach) with seed=5 basin + higher w-stop-threshold allows late-epoch frozen recovery past ep83 kill point. EMA trajectory: ep5 recall=0.572 ★=0.100; ep10 recall=0.740 ★=0.069; ep15 recall=0.708 ★=0.070; ep20 recall=0.730 ★=0.065; ep25 recall=0.691 ★=0.080 (mild collapse, −0.039 vs v191's −0.181); ep30 recall=0.635 ★=0.093 (W=0.931); **ep35 recall=0.750 ★=0.058 (recovery!)** (W=1.214); **ep40 recall=0.754 ★=0.057** (W=1.311, G=+0.69). EMA ★=0.057 at ep40 is 0.006 from ATB. **v194 beats v191 by +0.25 recall and 51% better ★ at ep40.** Interim frozen sweep launched ep5–ep40 (PID 3294366). Log `/home/darrell/train_alibaba_v194.log`.
