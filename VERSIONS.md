...
- **alibaba_v194** — **RUNNING** (PID 3288889, launched 2026-04-21). **IDEA #36 decoded-mode bc + `--w-stop-threshold 5.0`**, seed=5. Decoded-feat mode (NOT latent-H). Pretrain: v193 `pretrain_complete.pt` (seed=5). Same seed as ATB holder v165 (★=0.051). Hypothesis: decoded-mode bc (v191 approach) with seed=5 basin + higher w-stop-threshold allows late-epoch frozen recovery past ep83 kill point. EMA trajectory: ep5 recall=0.572 ★=0.100; ep10 recall=0.740 ★=0.069; ep15 recall=0.708 ★=0.070; ep20 recall=0.730 ★=0.065; ep25 recall=0.691 ★=0.080 (mild collapse); ep30 recall=0.635 ★=0.093; **ep35 recall=0.750 ★=0.058 (recovery)**; **ep40 recall=0.754 ★=0.057** (W=1.311). **Interim frozen sweep (seeds 42/42, ep5–ep40, 9 ckpts)**: frozen-best **epoch_0030.pt ★=0.12356** (MMD²=0.01336, β-rec=0.449). 26th mis-rank: best.pt(ep40) EMA ★=0.057 → frozen ★=0.126 (+122% worse). Frozen β-recall: ep30=0.449, ep40=0.416. **EMA inflation confirmed** — EMA ★=0.057 vastly overstates frozen quality. Note: v191 ep40 frozen ★=0.113 (β-rec=0.515) was slightly better than v194; seed=5 EMA is more inflated than seed=11. Phase transition expected ep55-80 (v191 had β-recall 0.46→0.71 in that window). Log `/home/darrell/train_alibaba_v194.log`.
