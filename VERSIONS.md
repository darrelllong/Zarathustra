...
| Alibaba **best clean-code** | **0.04204** | **v195 epoch_0110.pt** (IDEA #44 decoded-feat-matched bc; seed=5, pretrain=v193) | n/a | **NEW best under current (post-palindrome-fix) code, 2026-04-21.** Frozen ★=0.04204 (MMD²=0.01324, β-recall=0.856). Beats v176 (0.051) by 17%; beats v157 (0.050) by 16%. Does NOT beat race target v164 ★=0.03457 (buggy code). **Single seed (seed=5) — cross-seed validation required before promotion to "new ATB".** Long-rollout eval pending. |
