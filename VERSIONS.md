...
**Status** (2026-04-16, ~147 min in): PID 3946227, launched 16:01 PDT. **Phase 3 ep 24/200**. Best ★=**0.12575** at ep10 (recall=0.497). Trajectory: ep5=0.14286★ → **ep10=0.12575★** → ep15=0.15483 → ep20=0.19362 (recall crashed 0.331→0.263, MMD² 0.02515→0.04622, G=−5.0 more negative — early mode-collapse signal). Stale=**14/30**. W stable +0.33 to +0.64, far under 3.0 stop. **28.5% below alibaba ATB 0.176** from ep10 best. BCE supervision fix validated ★=0.12575 vs v120's ★=0.14294 (12% improvement), but post-peak trajectory is worse than v120's (v120 drifted ep25→ep60 in 0.14-0.17 range; v121 already hit 0.194 at ep20). Retrieval memory (98,913 params) + BCE reuse loss (0.5) active. Log: `/home/darrell/train_alibaba_v121.log`.
...
**Status** (2026-04-16, ~6.9h in): PID 3908775, started 11:16 PDT. **Phase 3 ep 138/200**. Best ★=**0.07048** at ep115 (recall=0.675, EMA MMD²=0.00548). Post-peak plateau: ep115=0.07048★ → ep120=0.09258 → ep125=0.07462 → ep130=0.07143 → ep135=0.07523 (recall=0.658 near-★ regime). Stale=**23/30** — approaching kill threshold. Next MMD at ep140 (stale=25 if no ★). If no new ★ by ep145, kill threshold triggers. W-breach at ep129 (+3.22) resolved; W +1.66-2.48 since. Training ★=0.07048 remains **60.4% below tencent ATB 0.178** and 8.2% better than v143 baseline — the strongest tencent training ★ in project history. Log: `/home/darrell/train_tencent_v146.log`.
