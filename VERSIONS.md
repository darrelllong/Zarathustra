...
- **alibaba_v204** — **LAUNCHED** (2026-04-21). **IDEA #54 v4: soft-sigmoid reuse_head, higher BCE weight (3.0)**. Seed=5. Config identical to v203 except `--gumbel-reuse-weight 3.0`. Key fix vs v203: BCE weight tripled so WGAN gradient (≈0.5/element at equilibrium) is overcome. Diagnosis from v203: at weight=1.0, BCE at equilibrium is ≈0.05/element (reuse_rate settled near zero); at weight=3.0, BCE forces logits to be positive when real says reuse (pos_weight up to 20×), expected equilibrium reuse_rate ≈ 0.15-0.30. PID=3575193 on vinge.local. **Acceptance bar**: reuse_rate ∈ [0.15, 0.30] by ep10; frozen ★ ≤ 0.050; long-rollout HRC-MAE < 0.010. Log `/home/darrell/train_alibaba_v204.log`.
