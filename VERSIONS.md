...
**Status** (2026-04-16, 21:53 PDT, ~50 min in): PID 4007894. **Phase 3 ep 10/200**. **Two ★s**: ep 5=0.13959 → **ep 10 ★=0.13447** (recall=0.408, MMD²=0.01617, desc_mse=0.0295). W strengthened 0.08→0.60 (healthy mid-range), G strengthened -1.3→-4.4 (critic is doing its job — opposite of v122's collapse). **MTPP-weight-0.1 hypothesis confirmed**: timing gradient without critic dominance. desc_mse rose from 0.0037 to 0.0295 (noisy but in v122's range). Need sub-0.073 training ★ to beat v114. Log: `/home/darrell/train_alibaba_v123.log`.
...
**Status** (2026-04-16, 21:53 PDT, ~170 min in): PID 3971604. **Phase 3 ep 54/200**. **Five ★s**, best=**ep 35 ★=0.08660**. Stale=**19**. ep 50 no-★ comb=0.09533 (recall=0.558). W healthy +1.75 to +2.34. G still weak (ep 50-54: -0.50/-0.67/-0.54/-1.14/-0.63) but NOT collapsed — no positive G, W never <1.5. Epoch times ballooned ep 52-54 (160-228s vs 90-100s normal) — likely GPU contention with v123 now in Phase 3. Not hopeless — training ★=0.0866 is 51% below 0.178 ATB. Log: `/home/darrell/train_tencent_v147.log`.
