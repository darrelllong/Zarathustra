...
**Status** (2026-04-16, ~4h in): PID 3913761, started 11:31 PDT. **Phase 3 ep 44/200**. Best training ★=**0.14294** at ep25 — three consecutive monotonic ★s: ep5=0.16815 → ep10=0.15004 → ep15=0.14514 → ep25=0.14294. Then drift up: ep30=0.15348, ep35=0.16756, ep40=0.17319. Stale=19/30. W=+0.63 (safe, under 3.0). Training ★=0.143 is **18.8% below alibaba ATB 0.176**. Retrieval-memory as pure architectural prior (BCE weight=0) appears to have helped in epochs 1–25 then faded. Kill threshold ep55 (stale=30) if no new ★ by then. Log: `/home/darrell/train_alibaba_v120.log`.
...
**Status** (2026-04-16, ~4h in): PID 3908775, started 11:16 PDT. **Phase 3 ep 63/200**. Best training ★=**0.08294** at ep55 — **sub-0.1 breakthrough** on the MTPP + chunk-stitching recipe. Trajectory: ep5=0.14596 → ep10=0.10502 → ep30=0.10087 → ep35=0.09685 → ep40=0.09510 → **ep55=0.08294**. Stale=8. W oscillating +1.5 to +2.3 (safe, under 3.0 cap). Training ★=0.083 is **53.4% below tencent ATB 0.178** and **sub-v143's ★=0.0768 baseline by 8%** at training scale. MTPP + chunk-stitching combo producing strongest tencent signal observed to date. Log: `/home/darrell/train_tencent_v146.log`. v145 killed (still in Gwarm-up; 22 min sunk, no GAN epochs run).
