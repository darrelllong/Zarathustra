...
- **alibaba_v193** — **RUNNING** (PID 3266300, launched 2026-04-21). **IDEA #36 + IDEA #42 (latent-H) + `--w-stop-threshold 5.0`**, seed=5. **ep20: recall=0.784, ★=0.055 (train-best); ep25: recall=0.783 (FLAT — no collapse!); ep30: dip 0.640; ep35: recovery 0.803, ★=0.049; ep40: recall=0.802, ★=0.04620 (new best); ep45: recall=0.786; ep50: recall=0.814, ★=0.04631 (new best).** W ≤ 1.3 throughout (vs v192 W=3.3 at ep35). Interim frozen sweep ep5–ep50: frozen-best ep40 ★=0.12528, β-rec=0.415. Frozen improving (0.183→0.125 over ep10-40). Late-epoch frozen breakthrough expected at ep70+ (v191 pattern). Log `/home/darrell/train_alibaba_v193.log`.
