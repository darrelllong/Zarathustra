...
- **alibaba_v189** — **IDEA #36 (Learned Boundary Prior)** on Alibaba. v176 pretrain reused (seed=7, phases 1–2 skipped); Phase 3 uses fresh LSTM G with `BoundaryCritic` WGAN-SN MLP (K=4, hidden=128, weight=0.5). All hand-written BS/OC scalars removed (weight=0). PCF and multi-scale-critic also dropped (per Round 33 / Round 32 guidance: drop those for Alibaba). `--n-regimes 4` (not 8 — 4 regimes are Alibaba-optimal per v46). Seed=7 to match v176 pretrain. First structural Alibaba run targeting boundary continuity without the palindrome bias. **ep5: ★=0.071**; **ep10: ★=0.082**; **ep15: ★=0.073**; **ep20: ★=0.099**; **ep30: ★=0.054 (train-best, recall=0.757)**; **ep35: ★=0.103, recall=0.586**; **ep40: ★=0.093, recall=0.591**; **ep45: ★=0.076, recall=0.757**; **ep55: ★=0.077, recall=0.779** (recall-peak trend: 0.709→0.733→0.757→0.757→0.779 = improving across training; ep30 ★=0.054 still train-best because MMD² better there; MMD² vs recall tradeoff emerging). v189 predates bc_gap instrumentation; v190 same recipe shows bc_gap~0.08-0.13 sustained. Log `/home/darrell/train_alibaba_v189.log`. PID 2137428.
