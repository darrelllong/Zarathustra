...
**Status** (2026-04-16, 22:04 PDT, ~61 min in): PID 4007894. **Phase 3 ep 13/200**. **Two ★s**: ep 5=0.13959 → **ep 10 ★=0.13447**. Stale=3. W strengthening (ep 11-13: 0.59/0.73/0.78, healthy mid-range), G strongly healthy -4.4/-4.8/-4.6 — **no critic collapse signal**. MTPP-weight-0.1 continues to work. Next ★ eval ep 15. Need sub-0.073 to beat v114. Log: `/home/darrell/train_alibaba_v123.log`.
...
**Status** (2026-04-16, 22:04 PDT, ~181 min in): PID 3971604. **Phase 3 ep 56/200**. **Five ★s**, best=**ep 35 ★=0.08660**. Stale=**21**. ep 55 near-miss: comb=0.08878 (recall=**0.606** BEATS best's 0.597; MMD²=0.00988 WORSE than best's 0.00600) — recall trajectory recovered but MMD² holding it back. W healthy +1.9-2.4. G still weak (ep 55=-0.88, ep 56=-0.66) but NOT collapsed (no positive G, W never <1.5). 50% below 0.178 ATB. Log: `/home/darrell/train_tencent_v147.log`.
