...
- **alibaba_v194** — **RUNNING** (PID 3288889, launched 2026-04-21). **IDEA #36 decoded-mode bc + `--w-stop-threshold 5.0`**, seed=5. Decoded-feat mode (NOT latent-H). Pretrain: v193 `pretrain_complete.pt` (seed=5). Same seed as ATB holder v165 (★=0.051). Hypothesis: decoded-mode bc (v191 approach) with seed=5 basin + higher w-stop-threshold allows late-epoch frozen recovery past ep83 kill point. EMA trajectory: ep5 recall=0.572 ★=0.100; ep10 recall=0.740 ★=0.069; ep15 recall=0.708 ★=0.070; ep20 recall=0.730 ★=0.065; ep25 recall=0.691 ★=0.080 (mild collapse); ep30 recall=0.635 ★=0.093; **ep35 recall=0.750 ★=0.058 (recovery)**; **ep40 recall=0.754 ★=0.057** (W=1.311). **Frozen sweeps (4 interim + final)**: ep30 ★=0.124 → ep45 ★=0.110 → ep55 ★=0.106 → ep65 ★=0.098 → **ep75 ★=0.06919** (β-rec=0.6875, frozen-best). **PHASE TRANSITION at ep75**: β-recall jumped 0.543→0.688 in one window (just like v191 ep55→ep75 jump 0.46→0.71). Training selector correct: best.pt = ep75 (0% mis-rank). EMA ep75: recall=0.820, ★=0.044 (new EMA best). Training at ep78: W=2.84 (rising), G=−2.44. DO NOT KILL — bc rule applies, only stop W>5.0×3. Gap: v194 ep75 ★=0.069 vs v191 ep75 ★=0.067 (2.5% worse) vs ATB v176 ★=0.051 (35% worse). Watching ep80+ for potential improvement beyond ep75. Log `/home/darrell/train_alibaba_v194.log`.
