...
- **alibaba_v193** — **RUNNING** (PID 3266300, launched 2026-04-21). **IDEA #36 + IDEA #42 (latent-H) + `--w-stop-threshold 5.0`**, seed=5. **ep5: recall=0.597, ★=0.101 (weak start); ep10: recall=0.746, ★=0.071; ep15: recall=0.773, ★=0.056; ep20: recall=0.784, ★=0.055 (train-best); ep25: recall=0.783, ★=0.063 (flat — no collapse!); ep30: recall=0.640, ★=0.097 (dip, W=0.79 stable); ep35: recall=0.803, ★=0.04881 (NEW BEST, recovery — W=1.03).** Exceptional stability — no V-spike (W ≤ 1.1 through ep35). EMA ★=0.049 below ATB frozen ★=0.051. Watching ep40+ for continued recovery. Log `/home/darrell/train_alibaba_v193.log`.
