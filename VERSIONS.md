...
- **alibaba_v193** — **RUNNING** (PID 3266300, launched 2026-04-21). **IDEA #36 + IDEA #42 (latent-H) + `--w-stop-threshold 5.0`**, seed=5. Rationale: v192 latent-H avoids decoded-mode ep25 collapse but W-stopped at ep35 (only 8 checkpoints). v191's frozen-best was ep75. Hypothesis: latent-H bc needs longer training — w-stop-threshold raised to 5.0. Pretrain: v189 `pretrain_complete.pt` (seed=7 pretrain). If v193 reaches ep70+ without W-stop, frozen sweep should reveal whether latent-H bc beats v191 ★=0.067. Log `/home/darrell/train_alibaba_v193.log`.
