...
**Status** (2026-04-16, ~87 min in): PID 3946227, launched 16:01 PDT. **Phase 3 ep 6/200 — FIRST ★=0.14286 at ep5** (recall=0.404, EMA MMD²=0.02366). **Matches v120's entire-run best (★=0.14294 at ep25) in 5 GAN epochs**, validating that the BCE supervision fix was the missing piece. W=+0.16 (ultra stable, nowhere near 3.0 stop). G loss tight -1.09 → -4.00 (healthy ramp). Stale=1/30. Training ★=0.14286 is already **18.8% below alibaba ATB 0.176**. AE pretrain clean; Supervisor 0.0319→0.0331; G warm-up sup=0.00164→0.00049 at ep100. Retrieval memory (98,913 params) + BCE reuse loss active. Log: `/home/darrell/train_alibaba_v121.log`.
...
**Status** (2026-04-16, ~6.2h in): PID 3908775, started 11:16 PDT. **Phase 3 ep 120/200**. **NEW RECORD ★=0.07048 at ep115** (recall=0.675, EMA MMD²=0.00548). Full trajectory: ep5=0.14596 → ep30=0.10087 → ep40=0.09510 → ep55=0.08294 → ep70=0.08010 → ep80=0.07667 → ep95=0.07467★ → ep105=0.09670 (G drift −5.19) → ep110=0.08254 (recovered) → **ep115=0.07048★** → ep120=0.09258 (second drift G=−3.38). Stale=5/30. Training ★=0.07048 is **60.4% below tencent ATB 0.178** and **8.2% better than v143's training ★=0.0768 baseline**. Two mid-run adversarial oscillations survived; W stable +1.75 to +2.60 throughout. MTPP + chunk-stitching + regime-sampler K=8 producing strongest tencent signal observed to date. Log: `/home/darrell/train_tencent_v146.log`.
