...
Launched `tencent_mdlstm_r440_wsmax_empiricalrank_norecycle_ws_p3` on vinge.
This is a real fit with `--ws-edge-mode max-window`, not a no-fit decode pass.
...
## Tencent r443 Exact-Short-Rank Fit Launched (2026-05-09)
...
## Tencent r444 Rank-Band Exact-Rank Fit Launched (2026-05-09)
...
## Tencent r445 Rank-Band Aux-Only Decode Completed, Not Promoted (2026-05-09)
